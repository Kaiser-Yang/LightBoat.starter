return {
  ...
  config = function()
    ...
    require('maplayer').setup({
      ...
      { key = 'j', desc = 'Record Position Before Movement', handler = record_jump_position_wrap('j'), expr = true },
      { key = 'k', desc = 'Record Position Before Movement', handler = record_jump_position_wrap('k'), expr = true },
      ...
      { key = '[d', mode = 'nox', desc = 'Diagnostic', handler = h.previous_diagnostic, fallback = false },
      { key = ']d', mode = 'nox', desc = 'Diagnostic', handler = h.next_diagnostic, fallback = false },
      ...
      { key = '<m-e>', desc = 'Open, Focus, or Reveal', handler = h.open_focus_reveal },
      ...
      { key = '<leader>sd', desc = 'Diagnostics', handler = '<cmd>Telescope diagnostics<cr>', fallback = false },
      { key = '<leader>sq', desc = 'Quickfix', handler = '<cmd>Telescope quickfix<cr>', fallback = false },
      { key = '<leader>sl', desc = 'Loclist', handler = '<cmd>Telescope loclist<cr>', fallback = false },
      ...
      { key = '<s-up>', desc = 'Resize Top Reverse', handler = h.resize_wrap('top', true), fallback = false },
      { key = '<s-down>', desc = 'Resize Bottom Reverse', handler = h.resize_wrap('bottom', true), fallback = false },
      { key = '<s-left>', desc = 'Resize Left Reverse', handler = h.resize_wrap('left', true), fallback = false },
      { key = '<s-right>', desc = 'Resize Right Reverse', handler = h.resize_wrap('right', true), fallback = false },
    ...
    if u.plugin_available('which-key.nvim') then
      require('which-key').add({
        ...
        { '<leader>d', icon = { icon = ' ', color = 'red' }, desc = 'Dap' },
