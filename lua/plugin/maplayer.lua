return {
  ...
  config = function()
    ...
    require('maplayer').setup({
      ...
      { key = '[A', mode = { 'n', 'x', 'o' }, desc = 'Previous Argument End', condition = c.treesitter_available, handler = h.previous_parameter_end },
      { key = ']A', mode = { 'n', 'x', 'o' }, desc = 'Next Argument End', condition = c.treesitter_available, handler = h.next_parameter_end },
      -- NOTE: Those four mappings below behavior like the default ones
      { key = '[m', mode = { 'n', 'x', 'o' }, desc = 'Previous Method Start', condition = c.treesitter_available, handler = h.previous_function_start },
      { key = ']m', mode = { 'n', 'x', 'o' }, desc = 'Next Method Start', condition = c.treesitter_available, handler = h.next_function_start },
      { key = '[M', mode = { 'n', 'x', 'o' }, desc = 'Previous Method End', condition = c.treesitter_available, handler = h.previous_function_end },
      { key = ']M', mode = { 'n', 'x', 'o' }, desc = 'Next Method End', condition = c.treesitter_available, handler = h.next_function_end },
      -- NOTE: Those eight mappings below behavior like the default ones
      { key = '[[', mode = { 'n', 'x', 'o' }, desc = 'Previous Block Start', condition = function() return c.treesitter_available() and c.not_filetype("help") end, handler = h.previous_block_start },
      { key = '[[', mode = { 'n', 'x', 'o' }, desc = 'Previous Section', condition = c.filetype_wrap('help'), handler = h.previous_section, priority = 100 },
      { key = ']]', mode = { 'n', 'x', 'o' }, desc = 'Next Block Start', condition = function() return c.treesitter_available() and c.not_filetype("help") end, handler = h.next_block_start },
      { key = ']]', mode = { 'n', 'x', 'o' }, desc = 'Next Section', condition = c.filetype_wrap('help'), handler = h.next_section },
      { key = '[]', mode = { 'n', 'x', 'o' }, desc = 'Previous Block End', condition = c.treesitter_available, handler = h.previous_block_end },
      { key = '][', mode = { 'n', 'x', 'o' }, desc = 'Next Block End', condition = c.treesitter_available, handler = h.next_block_end },
      -- NOTE: By default, "[i", "]i", "[I", and "]I" are used to show information of keywords under cursor
      { key = '[i', mode = { 'n', 'x', 'o' }, desc = 'Previous If Start', condition = c.treesitter_available, handler = h.rempove_previous_conditional_start },
      { key = ']i', mode = { 'n', 'x', 'o' }, desc = 'Next If Start', condition = c.treesitter_available, handler = h.rempove_next_conditional_start },
      { key = '[I', mode = { 'n', 'x', 'o' }, desc = 'Previous If End', condition = c.treesitter_available, handler = h.rempove_previous_conditional_end },
      { key = ']I', mode = { 'n', 'x', 'o' }, desc = 'Next If End', condition = c.treesitter_available, handler = h.rempove_next_conditional_end },
      -- NOTE: By default, "[f", "]f" are alias of "gf"
      { key = '[f', mode = { 'n', 'x', 'o' }, desc = 'Previous For Start', condition = c.treesitter_available, handler = h.previous_loop_start },
      { key = ']f', mode = { 'n', 'x', 'o' }, desc = 'Next For Start', condition = c.treesitter_available, handler = h.next_loop_start },
      { key = '[F', mode = { 'n', 'x', 'o' }, desc = 'Previous For End', condition = c.treesitter_available, handler = h.previous_loop_end },
      { key = ']F', mode = { 'n', 'x', 'o' }, desc = 'Next For End', condition = c.treesitter_available, handler = h.next_loop_end },
      -- NOTE: By default "[r" and "]r" are used to search "rare" words
      { key = '[r', mode = { 'n', 'x', 'o' }, desc = 'Previous Return Start', condition = c.treesitter_available, handler = h.previous_return_start },
      { key = ']r', mode = { 'n', 'x', 'o' }, desc = 'Next Return Start', condition = c.treesitter_available, handler = h.next_return_start },
      { key = '[R', mode = { 'n', 'x', 'o' }, desc = 'Previous Return End', condition = c.treesitter_available, handler = h.previous_return_end },
      { key = ']R', mode = { 'n', 'x', 'o' }, desc = 'Next Return End', condition = c.treesitter_available, handler = h.next_return_end },
      -- NOTE: By default, "[c" and "]c" are used to navigate changes in the buffer
      { key = '[c', mode = { 'n', 'x', 'o' }, desc = 'Previous Class Start', handler = h.previous_class_start },
